import { Catch, ArgumentsHost, HttpStatus, ExceptionFilter, Logger, HttpException } from '@nestjs/common';
...
export class AllExceptionsFilter<T> implements ExceptionFilter {
  constructor(private readonly httpAdapterHost: HttpAdapterHost, private readonly logger: Logger) {}
    ...
    let message = exception['response']?.message ? exception['response']['message'] : getErrorMessage<T>(exception);
